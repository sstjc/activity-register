...
//     })
// }
return _inherits(b,a),_createClass(b,[{key:"render",value:function h(){var a=this.state,b=a.member_id_checked,c=a.remember_checked,d=a.member_id,e=a.name,f=a.phone,g=null;return this.state.showMessage&&(g=React.createElement(Message,{toggleMessage:this.toggleMessage})),React.createElement("div",null,React.createElement("form",{action:"#"},React.createElement("div",{class:"container"},React.createElement("div",{class:"form-title"},React.createElement("h1",{class:"text-center"},"\u677E\u5C71\u6559\u6703\u9632\u75AB\u9EDE\u540D\u7CFB\u7D71"),React.createElement("div",{class:"check_id"},React.createElement("input",{class:"mr-1 big-checkbox",type:"checkbox",checked:this.state.member_id_checked,onClick:this.onClick.bind(this)}),"\u662F\u5426\u6709\u4FE1\u5F92\u7DE8\u865F")),React.createElement("div",{class:"input-item pt-3"},this.input_item_by_checkbox()),React.createElement("div",{class:"clearfix form-submit"},React.createElement("button",{type:"submit",class:"btn btn-primary",onClick:this.loginSubmit},"\u5831\u5230")))),g)}}]),b}(React.Component);